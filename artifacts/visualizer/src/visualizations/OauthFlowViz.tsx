...
const NODES = [
  { id: 0, icon: "👤", label: "Resource Owner", sub: "사용자 (브라우저)", x: 200, y: 40 },
  { id: 1, icon: "💻", label: "Client App", sub: "서비스 백엔드", x: 60, y: 180 },
  { id: 2, icon: "🔑", label: "Auth Server", sub: "인증 서버 (IDP)", x: 340, y: 180 },
  { id: 3, icon: "🖥️", label: "Resource Server", sub: "API 리소스 서버", x: 200, y: 300 },
];
...
const NODE_BASE = "absolute flex flex-col items-center gap-1 p-2 rounded-xl border-2 text-center transition-all duration-300 w-[100px] -translate-x-1/2 -translate-y-1/2 bg-card z-10 select-none shadow-sm";
...
export default function OauthFlowViz() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Diagram Area */}
      <div className="relative w-full max-w-[500px] h-[340px] mx-auto border border-border rounded-2xl bg-muted/5 overflow-hidden">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
          ...
          {/* User - Client */}
          <line x1={200} y1={40} x2={60} y2={180} stroke="currentColor" strokeWidth="1.5" className="text-border/40" strokeDasharray="3 3" />
          {/* User - Auth Server */}
          <line x1={200} y1={40} x2={340} y2={180} stroke="currentColor" strokeWidth="1.5" className="text-border/40" strokeDasharray="3 3" />
          {/* Client - Auth Server */}
          <line x1={60} y1={180} x2={340} y2={180} stroke="currentColor" strokeWidth="1.5" className="text-border/40" strokeDasharray="3 3" />
          {/* Client - Resource Server */}
          <line x1={60} y1={180} x2={200} y2={300} stroke="currentColor" strokeWidth="1.5" className="text-border/40" strokeDasharray="3 3" />
          {/* Resource Server - User */}
          <line x1={200} y1={300} x2={200} y2={40} stroke="currentColor" strokeWidth="1.5" className="text-border/40" strokeDasharray="3 3" />
